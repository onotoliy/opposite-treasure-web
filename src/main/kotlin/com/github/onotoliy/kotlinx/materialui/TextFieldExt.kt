...
import com.github.onotoliy.kotlinx.materialui.form.*
import com.github.onotoliy.kotlinx.materialui.input.MInputProps
...
fun RBuilder.mTextField(
    ...
    margin: MFormControlMargin = MFormControlMargin.dense,
...
fun RBuilder.mTextFieldSelect(
    ...
    if (variant == MFormControlVariant.standard) {
        attrs.inputProps = selectInputProps
    }

    setStyledPropsAndRunHandler(className, handler)
}

val selectInputProps = jsObject<MInputProps> {
