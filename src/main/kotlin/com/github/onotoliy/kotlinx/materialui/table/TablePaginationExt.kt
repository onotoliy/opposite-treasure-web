...
import com.github.onotoliy.kotlinx.materialui.button.MIconButtonProps
...
interface MTablePaginationProps : MButtonBaseProps {
    ...
    var count: Int
    var labelDisplayedRows: (from: Int, to: Int, count: Int) -> String
...
fun RBuilder.mTablePagination(
    ...
    count: Int? = null,
    labelDisplayedRows: ((from: Int, to: Int, count: Int) -> String)? = null,
